...
<?php echo form_open('result_update'); ?>
                        ...
                        <tbody>
                            ...
                            <?php if (@$result) {
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-3"><input style="text-align: center;" type="text" name="mark<?php echo $id; ?>" value="<?php echo $subject_info->mark;?>" class="form-control"></td>
