...
<div class="wrapper wrapper-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <?php echo form_open('report_card_search'); ?>
            ...
            <tbody>
                <?php if(@$student_data){
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="<?php echo base_url('Result_controller/report_card_view?s_id=');echo @$value->s_id;echo "&trm=";echo $term;echo "&class_id=";echo $value->s_class;?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                <?php }}?>
            </tbody>
