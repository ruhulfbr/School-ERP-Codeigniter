                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Students ID Card</h4>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="student_id_card_print" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print ID Card </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
