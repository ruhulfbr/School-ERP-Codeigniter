        ...
        <div class="ibox float-e-margins">
            ...
            <tbody>
                <?php if(@$applicant_data){
                    $num = 0;
                    foreach ($applicant_data as $value) { $num = $num+1; ?>
                    <tr>
                        <td><?php echo @$num;?></td>
                        ...
                        <td><?php if (@$value->status == 0) {
                            echo '<div style="color:#8a6d3b; font-weight:600;">Pending</div>';
                        }elseif(@$value->status == 1) {
                            echo '<div style="color:#3c763d; font-weight:600;">Approved</div>';
                        }elseif(@$value->status == 2) {
                            echo '<div style="color:#a94442; font-weight:600;">Disapproved</div>';
                        }?></td>
                        <td>
                            <div class="btn-group">
