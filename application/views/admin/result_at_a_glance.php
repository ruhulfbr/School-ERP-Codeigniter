...
<div class="row">
    <div class="col-sm-12">
         <?php if($class_id==1||$class_id==2||$class_id==3||$class_id==4||$class_id==5||$class_id==13||$class_id==14){ 
            $total_point=0; ?>
            <table class="table table-bordered">
                <thead>
            <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php  
                            ...
                            <td><?php $get_full_mark=$result_model_view->getFullMarksBySubjectGroupNo($val);
                                    
                                $mark=0;
                                foreach ($get_full_mark as $value) {
                                    $mark=$value->full_marks;
                                }
                                if($mark==1)
                                {
                                    echo '100';
