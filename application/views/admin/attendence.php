...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <?php echo form_open('attendence_search'); ?>
                <div class="col-sm-3">
                    <label>Class</label>
            ...
            <div class="ibox-content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                      ...
                      $student_data = @$machine_model_view->entry_logs_search($from,$st_id); 

                        if ($student_data>0) { 
                          $attendence_time_first = $machine_model_view->attendence_time_first($from,$st_id);
                          $entry = $attendence_time_first->logged_time;

                          $attendence_time_last = $machine_model_view->attendence_time_last($from,$st_id);
